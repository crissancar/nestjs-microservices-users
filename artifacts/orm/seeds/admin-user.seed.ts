...
import {AdminUserEntity} from '../../../src/app/modules/admin-MICROSERVICE_USERS/persistence/admin-user.entity';
import {config} from '../../../src/config/app/index';

const { seeds } = config.typeorm;

export default class AdminMICROSERVICE_USERSeed extends Seeder {
